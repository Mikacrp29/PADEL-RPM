...
function TikTokIcon() {
  // lucide-react has no TikTok glyph — this is a widely-used simplified
  // redraw of the mark, filled to match how the real logo reads at small
  // sizes (a thin outline version becomes illegible at 18px).
  return (
