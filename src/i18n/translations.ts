...
export const translations = {
  fr: {
    ...
    'slotDetails.bookCourt': '🎾 Réserver le terrain',
           'slotDetails.reservationPlaceholder': 'Choisir un site de réservation',
    'slotDetails.reservationHint': '👆 Sélectionne un site avant de cliquer sur Aller',
            'slotDetails.go': 'Aller',
  ...
  en: {
    ...
    'slotDetails.bookCourt': '🎾 Book the court',
            'slotDetails.reservationPlaceholder': 'Choose a booking site',
    'slotDetails.reservationHint': '👆 Select a site before clicking Go',
            'slotDetails.go': 'Go',
